...
<div class="box">
  ...
  <div class="box-body">
    <div class="box-body">
      ...
      <input type="hidden" name="id_tempat_kp" value="{{$id_tempat_kp}}">
      <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
        <label for="nama">Nama Pembimbing</label>
        <input type="text" class="form-control" id="nama" placeholder="Nama Pembimbing" name="nama" value="{{old('nama')}}">
        @if ($errors->has('nama'))
      ...
      <div class="form-group{{ $errors->has('hp') ? ' has-error' : '' }}">
            ...
            <input type="number" class="form-control" id="hp" placeholder="No Telp Pembimbing" name="hp" value="{{old('hp')}}">
            @if ($errors->has('hp'))
                <span class="help-block">
